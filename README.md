<img width="512" height="512" alt="icon" src="https://github.com/user-attachments/assets/49dfed79-0552-4336-bc6c-1dc2bf24ac89" />
...
**IMPORTANT!!!**
QSE does not have a check for a sane operating system (POSIX compliant), do NOT expect it to work on every os that dotnet supports. If you want to run it on windows, try WSL.
