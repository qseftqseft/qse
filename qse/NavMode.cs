...
namespace qse
{
    class NavMode
    {
        public static void modetwo(ConsoleKeyInfo keyInfo1, int line, int column, bool r, string autocomp, List<char> file, int scroll, int hscroll, int curchar, List<int> filelenghts, int tab, char[] ignclr, bool code, int top, int sugsc, string[] suggest, int mode, char prevch, char prevtf, int prevtfm,
